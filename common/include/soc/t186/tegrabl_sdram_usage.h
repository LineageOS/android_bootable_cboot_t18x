...
#define RAMDISK_ADDRESS			0xA0000000
#define RAMDISK_MAX_SIZE		0x0C000000
#define BOOT_IMAGE_MAX_SIZE		0x04000000
#define BOOT_IMAGE_LOAD_ADDRESS	0xAC000000
#define VENDOR_BOOT_IMAGE_LOAD_ADDRESS	0xB0000000
...
#define LINUX_LOAD_ADDRESS		0x80200000
